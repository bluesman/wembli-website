...
exports.rpcDispatchHooks = {
    ...
    post: function(req,res,result,respond) {
        ...
        if (typeof req.session !== "undefined") {
            console.log('adding customer to rpc response');
            if (req.session.customer) {
                console.log('have a customer');
                var safeCustomerFields = ['email','firstName','lastName','zipCode','confirmed','id','merchantAccount'];
                result.customer = {};
