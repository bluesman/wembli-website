...
module.exports = {
	...
	'sendPonyUpEmail': function(args, cb) {
		...
		var payLink = "http://" + app.settings.host + ".wembli.com/plan/"+args.req.session.plan.guid+'/pony-up';
	...
	'sendRsvpChanged': function(args, cb) {
		var callback = (typeof cb === "undefined") ? defaultCb : cb;
		var alternateText = 'Your ears must be ringing ‘cause your guests are talking about your invitation to '+args.plan.event.eventName+'!  Check out who’s just RSVP’d by clicking here: https://www.wembli.com/plan/'+args.plan.guid+'/rsvp';
		var sendArgs = {
			'res': args.res,
