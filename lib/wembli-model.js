...
var host = (process.env.NODE_ENV === 'production') ? 'mongo01.wembli.com' : 'localhost';
var connectString = 'mongodb://'+host+'/wembli';
console.log('connecting to mongo server: '+connectString);
