...
}(window, document), angular.module("wembliDirectoryApp.controllers", []).controller("MainCtrl", [ function() {} ]), 
...
} ]), angular.module("wembliDirectoryApp", [ "wembliDirectoryApp.controllers", "wembliApp.services.header", "wembliApp.directives.header" ]).run([ "$rootScope", "$window", function() {} ]);