...
!function($, undefined) {
    ...
    $.cleanData = function(elems) {
        ...
        constructor = $[namespace][name] = function(options, element) {
            return this._createWidget ? (arguments.length && this._createWidget(options, element), 
            void 0) : new constructor(options, element);
    ...
    var f = {
        ...
        GetSelectedSections: function(h) {
            ...
            return d.each(f.Selection, function(m, j) {
                ...
                if (l) {
                    ...
                    if (h) return g.push(f.OtherSections[j].Name), void 0;
        ...
        ProcessTickets: function() {
            ...
            d.each(f.Sections, function(m, n) {
                ...
                f.ToggleSelection(m, !0, !0), h = !0), f.Sections[m].Active = !1, n.SetStyle(f.Settings.InactiveStyle), 
                void 0) : (n.SetStyle(f.Settings.NormalStyle), f.Groups[n.GroupId].ActiveSections++, 
                void 0);
        ...
        GetZone: function(h) {
            ...
            return d.each(f.Groups, function(k, j) {
                return j.Name.toLowerCase() == h.toLowerCase() ? (g = j.Id, !1) : (d.each(j.Alias, function() {
        ...
        ShowTickets: function() {
            if (null == f.Settings.TicketsListContainer) return null != f.Settings.RowSelector && (d(f.Settings.RowSelector).hide(), 
        ...
        ShowTooltip: function(k, j, n) {
            if (!f.TooltipZoomed) {
                ...
                var m = f.Sections[k];
                if (!(f.Settings.AlwaysShowTooltip || m.Active && 0 != m.Quantity)) return f.HideTooltip(), 
                void 0;
        ...
        ShowSectionView: function(k, g) {
            if (f.Settings.SectionViewContainer && f.Settings.SectionViewTrigger == g) {
                var j = f.Sections[k];
                if (!j.SectionViewUrl) return f.HideSectionView(g), void 0;
        ...
        Initialize: function(i) {
            ...
            e.Container = d("<div>").attr("class", "tuMapContainer").attr("style", "position:relative;margin:auto;overflow:hidden;width:" + h + "px;height:" + n + "px").appendTo(i).disableSelection().mousemove(function(o) {
                ...
                e.TranslatePos.y = o.clientY - e.StartDragOffset.y, e.Translate(), void 0) : void 0;
    ...
    b.Map.Section = function(g) {
        ...
        return null != f[g] ? "function" == typeof f[g] ? f[g].apply(this, Array.prototype.slice.call(arguments, 1)) : f[g] : "object" != typeof g && g ? (d.error("Method " + g + " does not exist"), 
        void 0) : f.Initialize.apply(this, arguments);
    };
    var a = {
        init: function() {
    ...
    $scope.$watch("tickets", function(newVal, oldVal) {}), $scope.handlePriceRange = function() {
        ...
        "friend" === $scope.context && ($scope.backToPlan = !0), wembliRpc.fetch("event.getTickets", {
            ...
            if (console.log("fetched tix"), err) return alert("error happened - contact help@wembli.com"), 
            void 0;
    ...
    $scope.tnUrl = ticketPurchaseUrls.tn, $scope.listId = "a55323395c", plan.get(function() {
        ...
        signup: function() {
            wembliRpc.fetch("customer.signup", {
                ...
                result.exists) return $scope.formError = !1, $scope.signupError = !0, $scope.accountExists = result.exists, 
                void 0;
                if (result.formError) return $scope.signupError = !0, $scope.formError = !0, $scope.accountExists = !1, 
                void 0;
    ...
    plan.get(function(p) {
        ...
        plan.addTicketGroupReceipt({
            ...
            $("#tickets-offsite-modal").modal("hide"), $scope.continueLink ? $location.path($scope.continueLink) : $location.path("/plan");
            var t = plan.getTickets(), newT = [];
            if ("undefined" == typeof t[0]) newT.push(result.ticket); else for (var i = 0; i < t.length; i++) (t[i]._id = result.ticket._id) ? newT.push(result.ticket) : newT.push(t[i]);
