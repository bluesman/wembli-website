...
!function($, undefined) {
    ...
    $scope.handlePriceRange = function() {
    ...
    }), $scope.$watch("selectedQty", function(newVal) {
        if (newVal) {
            ...
            if (ticket) {
                ...
                ticket.amountPaid = amountPaid.toFixed(2), $scope.amountPaid = ticket.amountPaid;
            }
        }
        ...
        $scope.buyTicket = function(idx) {
            ...
            $scope.selectedQty = ticket.selectedQty, console.log(ticket);
            ...
            console.log("removing ticket id: " + id), plan.removeTicketGroup({
                ...
                $scope.buyTicketsOffsite && ($scope.buyTicketsOffsite = !1, overlay.hide()), $scope.ticketsConfirm && ($scope.ticketsConfirm = !1, 
                overlay.hide());
            });
        ...
        wembliRpc.fetch("event.getTickets", {
            ...
            angular.forEach(result.tickets, function(el) {
                ...
                el.ticketsInPlan = !1, angular.forEach(plan.getTickets(), function(ticketInPlan) {
                    ...
                    "undefined" != typeof ticketInPlan._id && (el._id = ticketInPlan._id));
