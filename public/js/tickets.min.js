    ...
    $scope.handlePriceRange = function() {
        ...
        if (newVal) {
            ...
            if (ticket) {
                ...
                ticket.amountPaid = amountPaid.toFixed(2), $scope.currentTicket.amountPaid = ticket.amountPaid;
            }
        }
        ...
        $scope.buyTicket = function(idx) {
            ...
            $scope.currentTicket = ticket, $scope.currentTicket.selectedQty = ticket.selectedQty, 
            console.log(ticket);
