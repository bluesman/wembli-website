...
!function($, undefined) {
    ...
    $scope.$watch("tickets", function(newVal, oldVal) {}), $scope.handlePriceRange = function() {
        ...
        "friend" === $scope.context && ($scope.backToPlan = !0), wembliRpc.fetch("event.getTickets", {
            ...
            }), $scope.tickets = newT, $scope.sortByPrice();
            ...
            options.OnInit = function(e, data) {
                $("#venue-map-loading").hide(), console.log("maptype: "), console.log(data.MapType), 
                "Interactive" === data.MapType && /ga_venue_tn/.test($scope.plan.event.data.MapUrl);
                ...
                Group.Selected;
            }, options.OnTicketSelected = function() {}, options.OnReset = function() {}, $("#tickets-list > div").css("height", $($window).height() - 172), 
            tuMap.init("#venue-map-container", options), $(".price-slider").length) {
                $(".price-slider").slider({
                    range: !0,
