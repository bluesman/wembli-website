    ...
    $scope.minTixPrice = 0, $scope.maxTixPrice = 200, $scope.ticketsChosen = !1, $scope.handlePriceRange = function() {
        ...
        $scope.buyTicket = function(idx) {
            ...
            console.log("add ticketgroup"), console.log(ticketGroup), plan.addTicketGroup(ticketGroup, function(err, results) {
                console.log(results), ticket.ticketsInPlan = !0, results.ticketGroup._id && (ticket._id = results.ticketGroup._id), 
            ...
            if ("undefined" == typeof index) return $scope.buyTicketsOffsite = !1, void overlay.hide();
            ...
            console.log("removing ticket id: " + id), plan.removeTicketGroup({
                ...
                $scope.buyTicketsOffsite && ($scope.buyTicketsOffsite = !1, overlay.hide());
            });
