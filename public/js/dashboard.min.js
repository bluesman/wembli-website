    ...
    $scope.$on("bank-account-created", function() {
        ...
        if (!$scope.submitInProgress) {
            ...
            wembliRpc.fetch("customer.createCreditCard", args, function(err, result) {
                ...
                $scope.errorMessage = err, $scope.success = !1, void 0) : result.success ? ($scope.success = !0, 
                $rootScope.$broadcast("credit-card-created", result.friend), $window.location.href = "/dashboard/payment-information", 
                void 0) : ($scope.error = !0, $scope.success = !1, $scope.errorMessage = result.error, 
                void 0);
            });
        }
...
} ]), angular.module("wembliApp.directives.dashboard", []).directive("dashboard", [ "customer", "fetchModals", "$rootScope", "wembliRpc", "$location", "loadingModal", function(customer, fetchModals, $rootScope, wembliRpc, $location, loadingModal) {
    return {
        restrict: "C",
        compile: function() {
            return function(scope) {
                scope.$on("customer-changed", function() {
                ...
                }), loadingModal.show("Fetching Your Plans..."), wembliRpc.fetch("dashboard.init", {}, function(err, result) {
                    return err ? (alert("error happened - contact help@wembli.com"), void 0) : (("undefined" == typeof result.customer.balancedAPI || "undefined" == typeof result.customer.balancedAPI.creditCards || "undefined" == typeof result.customer.balancedAPI.creditCards.items[0]) && (scope.needCreditCardInfo = !0), 
                    ...
                    scope.dashboard = result, customer.set(result.customer), console.log(result), $rootScope.$broadcast("dashboard-fetched", result), 
                    void 0);
                });
            };
        }
...
} ]).directive("updateCustomerInfo", [ "customer", "wembliRpc", "$rootScope", "$location", "loadingModal", function(customer, wembliRpc, $rootScope, $location, loadingModal) {
    return {
        restrict: "C",
        replace: !1,
        cache: !1,
            ...
            return function(scope) {
                scope.$on("dashboard-updateCustomerInfo", function() {
                    ...
                    wembliRpc.fetch("customer.updateAccountHolderInfo", accountInfo, function(err) {
                        ...
                        $("#edit-customer-account").modal("hide"), loadingModal.hide();
                    }, function(data) {
                        return loadingModal.show("Securely saving your information..."), data;
                    }, function(data) {
...
} ]).directive("addBankAccount", [ "customer", "wembliRpc", "$rootScope", "$location", "loadingModal", function(customer, wembliRpc, $rootScope, $location, loadingModal) {
    return {
        restrict: "C",
        replace: !1,
        cache: !1,
            ...
            return function(scope) {
                scope.addBankAccount = function() {
                    ...
                    wembliRpc.fetch("customer.addBankAccount", accountInfo, function(err) {
                        err && alert("something bad happened contact help@wembli.com"), $location.hash("#payment-information"), 
                        $("#add-bank-account").modal("hide"), loadingModal.hide();
                    }, function(data) {
                        return loadingModal.show("Securely saving your information..."), data;
                    }, function(data) {
                        return JSON.parse(data);
...
} ]).directive("deleteBankAccount", [ "customer", "wembliRpc", "$rootScope", "$location", "loadingModal", function() {
    return {
        restrict: "C",
        replace: !1,
        cache: !1,
