...
controller('InviteFriendsWizardCtrl', [
	function() {}
]).
...
controller('EventOptionsCtrl', ['$scope', '$http', '$compile', '$location', 'wembliRpc', 'plan',
	function($scope, $http, $compile, $location, wembliRpc, plan) {
		//init login vars
		var args = {};
...
controller('LoginCtrl', ['$scope', '$http', 'wembliRpc',
...
controller('SupplyPasswordCtrl', ['$scope',
	function($scope) {
...
controller('TicketsCtrl', ['$scope', 'wembliRpc', 'fetchModals', 'plan', 'customer', 'ticketPurchaseUrls',
	function($scope, wembliRpc, fetchModals, plan, customer, ticketPurchaseUrls) {
