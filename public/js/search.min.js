...
!function($) {
...
} ]), angular.module("wembliApp.controllers.search", []).controller("EventListCtrl", [ "$scope", "$location", "wembliRpc", "$filter", "$rootScope", "plan", "$timeout", function() {} ]).controller("SearchCtrl", [ "$scope", "$rootScope", "$window", "wembliRpc", "googleAnalytics", "overlay", function($scope, $rootScope, $window, wembliRpc, googleAnalytics, overlay) {
    ...
    $scope.showPaymentType = !1, $scope.$on("search-page-loaded", function() {
        ...
        $scope.eventData = eventData, $scope.showPaymentType = !0, overlay.show();
    }, $scope.closePaymentModal = function() {
        $scope.showPaymentType = !1, overlay.loading(!1), overlay.hide();
