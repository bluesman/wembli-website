...
} ]), angular.module("wembliApp.controllers.plan", []).controller("PlanCtrl", [ "$scope", "plan", "planNav", "customer", "overlay", "cart", "notifications", "googlePlaces", function($scope, plan, planNav, customer, overlay, cart, notifications, googlePlaces) {
