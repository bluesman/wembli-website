...
} ]).directive("wembliOverlay", [ "$rootScope", function($rootScope) {
    return {
        restrict: "A",
        compile: function(element) {
            element.click(function() {
                console.log("broadcast overlay clicked"), $rootScope.$broadcast("overlay-clicked");
            });
        }
    };
...
} ]).factory("overlay", [ "$rootScope", function() {
    return {
        show: function() {
            console.log("show overlay"), angular.element("#overlay").addClass("overlay");
        },
        hide: function() {
            angular.element("#overlay").removeClass("overlay");
        },
        loading: function(bool) {
            bool ? angular.element("#overlay > .overlay-loading").removeClass("hide") : angular.element("#overlay > .overlay-loading").addClass("hide");
        }
    };
