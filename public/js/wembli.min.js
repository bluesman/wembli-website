...
!function(window, undefined) {
    ...
    function minErr(module) {
        return function() {
            ...
            }), message = message + "\nhttp://errors.angularjs.org/1.2.22-build.366+sha.76a0eb8/" + (module ? module + "/" : "") + code, 
    ...
    var csp = function() {
        ...
        full: "1.2.22-build.366+sha.76a0eb8",
        major: 1,
        minor: 2,
        dot: 22,
        codeName: "snapshot"
...
angular.module("wembliApp.directives", []).directive("toggleSelected", [ function() {
    ...
    return {
        restrict: "CA",
        link: function(scope, element) {
            element.hasClass("invisible") && element.removeClass("invisible"), element.hasClass("visible") || element.addClass("visible");
        }
    };
    ...
    return {
        restrict: "CA",
        link: function(scope, element) {
            element.hasClass("visible") && element.removeClass("visible"), element.hasClass("invisible") || element.addClass("invisible");
        }
    };
    ...
    return {
        ...
        link: function(scope, element, attr) {
            scope.$watch(attr.level, function(pl) {
                ...
                if (!len && "undefined" != typeof pl) for (var d = parseInt(pl), i = d; i > 0; i--) element.append('<i class="fa fa-usd"/>');
            });
        }
    };
    ...
    return {
        ...
        link: function(scope, element, attr) {
            ...
            scope.$watch(attr.rating, function(rating) {
                var len = element.children().length;
                if (!len && "undefined" != typeof rating) {
