...
client01.indices.delete({index:'ticket_network'}, function(err, res) {
  console.log(err);
  console.log(res);

  client01.indices.create({index:'ticket_network'}, function(err, res) {


		var types = ['venues', 'performers', 'events'];
		var types = ['venues'];
